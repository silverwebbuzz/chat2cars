...
// ---------------- Event Invitation Validation End ---------------// 
...
const constructError = function (errors) {
  ...
  if(err.keyword === "format"){
    code = err.parentSchema.errorMessages.type.code;
    message = err.parentSchema.errorMessages.type.message;
    console.log("inside the formating condition");
  }
